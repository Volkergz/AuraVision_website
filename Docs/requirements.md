...
| R-10 | Sección de contacto                | La página debe ofrecer una vía de contacto para stakeholders. **Pendiente decidir**: botón `mailto:` o formulario (Formspree u otro).                                                                                                                                   | Completado    |
...
| R-12 | Imágenes fáciles de reemplazar      | Las imágenes deben vivir en `public/images/` con nombres fijos y documentados (`isotipo.png`, `colaboradores/haleym.png`, `hitos/hito-2-img-1.jpg`) para reemplazarlas copiando el archivo.                                                                              | Completado    |
...
| R-17 | Tipografía oficial                  | La fuente oficial de la marca es **Neuropolitical** (para marca y títulos). Evaluar fallback/web font si no está disponible en web.                                                                                                                                      | Completado    |
...
| R-19 | Isotipo                             | Isotipo subido por el usuario en `public/images/isotipo.png` (PNG con fondo transparente).                                                                                                                                                                             | Completado    |
| R-20 | Imagotipo                           | Disposición: **Isotipo arriba y centrado sobre el Logotipo**. Implementado en `src/components/Imagotipo.astro` y usado en el Footer.                                                                                                                                   | Completado    |
...
1. **Contacto (R-10):** se implementó botón de email (`mailto:`) por defecto. Si se decide un
   formulario, se requiere un servicio externo (ej. Formspree, gratis con límite) y se actualizaría el CTA.
2. **Fuente secundaria de texto (R-17):** definir fuente web para párrafos
   (ej. Inter, Space Grotesk) mientras se resuelve la licencia/uso de Neuropolitical.
3. **Links relevantes (R-6):** completar demo/sitio, repositorio GitHub y redes
   en `Docs/proyect-context.md` (sección 12).
4. **Placeholders de fuente APA (R-21):** completar autor, año, título y URL de
   las cifras del hook.
5. **Isotipo (R-19):** el usuario debe subir el archivo `public/images/isotipo.png`.
6. **Contenido de timeline y colaboradores:** definir datos reales
   (fechas, nombres, fotos, links de LinkedIn/GitHub).